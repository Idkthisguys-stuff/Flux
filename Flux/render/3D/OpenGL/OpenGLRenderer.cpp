...
static void setMat3(unsigned int p, const char *n, glm::mat3 m)
{
...
void Renderer3D::InitShadowMap(int resolution)
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT32F, resolution, resolution, 0, GL_DEPTH_COMPONENT, GL_FLOAT,
                 nullptr);
...
void Renderer3D::DrawSkybox(glm::mat4 view, glm::mat4 proj, glm::vec3 sunDir, float timeOfDay, bool hasLightingNode)
{
...
void Renderer3D::InitBillboard()
{
    ...
    float quad[] = {-0.5f, 0.5f, 0.f, 1.f, -0.5f, -0.5f, 0.f, 0.f, 0.5f, -0.5f, 1.f, 0.f,
                    -0.5f, 0.5f, 0.f, 1.f, 0.5f,  -0.5f, 1.f, 0.f, 0.5f, 0.5f,  1.f, 1.f};
...
void Renderer3D::DrawBillboard(unsigned int texID, glm::vec3 worldPos, float size, glm::mat4 view, glm::mat4 proj)
{
    if (!texID)
        return;
